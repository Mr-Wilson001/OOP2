...
// Define sub class(Student) that extends the base class(Person)
class Student extends Person {
    static students = [];
    #address;
    #parentOrGuardian;

    constructor(name, id, age, sex, Department, level, courses = [], address, parentOrGuardian) {
        super(name, age, sex);
        this.id = id;
...
Student.addStudent("Ogugor Chigozie", 2025664012, 19, "M", "Mathematics", 100, mathematicsDeptCourses, "No 32 majuo street, Awka", "Mr. and Mrs. Ogugor");
Student.addStudent("Okeke Chikaima",2025336047, 20, "F", "History", 100, historyDeptCourses, "No. 39 lions street, Amawbia", "Mr. and Mrs. Okeke");
...
console.log(Student.viewStudentDetails("Okeke Amaka"));